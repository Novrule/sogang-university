...
bool hash_cmp(const struct hash_elem *a, const struct hash_elem *b, void *aux) {
  return hash_func(a, aux) < hash_func(b, aux);
}

void hash_double(struct hash_elem *e, void *aux) {
  struct hash_item *item = hash_entry(e, HASH_ITEM, elem);
